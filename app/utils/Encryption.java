...
public class Encryption {
	...
	public static void main(String[] a) {
		String pass = "123456";
		Encryption en=Encryption.instance();
		byte[] salt=en.nextSalt();
		System.out.println(en.getEncryptedChar(pass,salt));
		System.out.println(en.byteToHexString(salt));
//		String code="5f4f0a95055fd11a1dd19060f8b06b29";
//		String salts="55959ae50dea53c917a35980";
//	    System.out.println(validPassword(pass, code, salts));
	}
}
